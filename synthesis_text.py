...
imgsize = [860, 1024, 860,1024, 680]  # 背景图片缩放尺寸
width_list = [240,260,280,320,340,300,320,240,260,320,220,256,250,256,248,220,200,224]  # 生成样本实际宽度，自定义
height_lsit = [34,38,42,34,36,32,40,34,36,36,32,36,30,28,32,32,28]  # 生成样本实际高度，自定义

root = './data/train' # 生成样本数据存放路径
...
batch = 20000  # 生成图片批次（不是实际生成图片数量），自定义，一批大概10张图片
wordclassnum = {}  # 统计字典
